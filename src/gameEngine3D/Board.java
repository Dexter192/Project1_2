...
/**
 * This class represents a 3D Model of a Board. It holds a Model, a
 * ModelInstance and a ModelBuilder
 * <ul>
 * <li>Model - The Model containing information about size and position of the
 * board. It can be retrieved by calculating the BoundingBox of the model
 * <li>ModelInstance - The Modelinstance is what is drawn on the screen. It is
